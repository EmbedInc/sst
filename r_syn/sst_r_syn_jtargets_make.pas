{   Subroutine SST_R_SYN_JTARGETS_MAKE (TARG_IN, TARG_OUT, MOD_YES, MOD_NO, MOD_ERR)
*
...
*   SST_R_SYN common block.  A pointer to a real label symbol indicates that
...
module sst_r_syn_jtargets_make;
define sst_r_syn_jtargets_make;
