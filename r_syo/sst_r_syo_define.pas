{   Subroutine SST_R_SYO_DEFINE
*
*   Process DEFINE syntax.
}
module sst_r_syo_define;
define sst_r_syo_define;
...
*   Process EXPRESSION syntax.
  ...
  sst_r_syo_expression (               {process EXPRESSION syntax}
    jtarg,                             {jump targets}
    mflag_p^);                         {descriptor for MFLAG variable to set}

  sst_r_syo_jtargets_done (jtarg);     {create any neccessary labels here}
{
**************************************
*
